<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterAdmin.aspx.cs" Inherits="eBuyAntiquesStore2.admin.Register" %>
...
<body>
    ...
    <table align="center" style="width: 700px; height: 781px; background-color: #5f98f3">
        ...
        <tr>
            ...
            <td>
                &nbsp;
                <asp:HyperLink ID="HP1" runat="server" Text="Already a member?" NavigateUrl="LoginAdmin.aspx"></asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td colspan="2">
